...
import com.qingmang.baselibrary.utils.DateUtil;
...
public class DatePicker extends WheelPicker {
    ...
    public void setRangeMonth(int startMonth, int endMonth) {
        months.clear();
    ...
    public void setRangeMonthOfDay(int startDay, int endDay) {
        days.clear();
        this.endDay = endDay;
    ...
    protected View initContentView() {
        int itemWidth = screen.widthPixels*4/16;
        ...
        monthView.setLayoutParams(new LinearLayout.LayoutParams(itemWidth, WRAP_CONTENT));
        ...
        dayView.setLayoutParams(new LinearLayout.LayoutParams(itemWidth, WRAP_CONTENT));
        ...
        if (!mode.equals(Mode.MONTH_DAY)) {
            ...
            yearView.setOnWheelViewListener(new WheelView.OnWheelViewListener() {
                ...
                public void onSelected(boolean isUserScroll, int selectedIndex, String item) {
                    ...
                    if(stringToYearMonthDay(months.get(selectedMonthIndex))== DateUtil.iGetMonth()&&
                            stringToYearMonthDay(years.get(selectedYearIndex))== DateUtil.iGetYear()){
